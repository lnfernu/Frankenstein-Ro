...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_SHIBA_PACK1);
	export_constant(IG_SHIBA_PACK2);
	export_constant(IG_SHIBA_PACK3);
	export_constant(IG_SHIBA_PACK4);
	export_constant(IG_SONIC_PACK3);
	export_constant(IG_SONIC_PACK1);
